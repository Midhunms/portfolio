...
KRUUZ provides a platform for cities, college campuses, apartment buildings, and other facilities to transport in a modern way using electric scooters. We want to help small cities and communities create an avenue to sustainable transportation lifestyles, the goals of which include using clean energy, reducing carbon emissions, and minimising traffic congestion.
